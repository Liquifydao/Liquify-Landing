...
const tabContents = [
  ...
  },
  {
    ...
    title: "Our Partners",
    description1:
      "Collaborating with leading DeFi protocols and infrastructure providers.",
    description2:
      "Liquify integrates with trusted ecosystem partners to deliver secure and sustainable yield opportunities.",
    leverage: "",
    buttonText: "Partners →",
                  ...
                  <>
                    ...
                    {activeContent.link && (
                      <a
                        ...
                        className="mt-2 bg-gradient-to-r from-purple-600 to-indigo-600 px-6 py-2 rounded-xl font-semibold inline-block hover:opacity-90 transition"
                      >
